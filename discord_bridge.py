        ...
        metadata.update(
            {
                ...
                "expression_intent": symbolic.get("expression_intent"),
                "expression_realisation": symbolic.get("expression_realisation"),
                "expression_realisations": symbolic.get("expression_realisations"),
